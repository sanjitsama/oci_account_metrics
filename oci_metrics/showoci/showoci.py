...
def execute_extract(cmd=None, report_dir=None):
    # get parset cmd
...
# set parser
##########################################################################
def set_parser_arguments(tenancy=None):
    parser = argparse.ArgumentParser()
    parser.add_argument('-a', action='store_true', default=False, dest='all', help='Print All Resources')
    parser.add_argument('-ani', action='store_true', default=True, dest='allnoiam', help='Print All Resources but identity')
    ...
    parser.add_argument('-t', default=f"{tenancy}", dest='profile', help='Config file section to use (tenancy profile)')
    parser.add_argument('-date', default="", dest='datetime', help='Print Datetime')
    ...
    parser.add_argument('-csv', default=f"{report_dir}/csv/{tenancy}_report", dest='csv', help="Output to CSV files, Input as file header")
    ...
    parser.add_argument('-sjf', default=f"{report_dir}/{tenancy}_report.json", type=argparse.FileType('w'), dest='sjoutfile', help="Output to screen (nice format) and JSON File")
